...
**数据库 ID：**
- 每周工作周报: `7ccdc19a-e680-478b-950f-d89399001571`
- 每月工作月报: `7b70e2ab-eae8-4f4e-b1b3-4054b4df0a48`
...
**校验点**: 扫描仓库数必须等于 3（config.json 中的仓库数量）。
...
const result = await notionRequest(
  `/databases/7ccdc19a-e680-478b-950f-d89399001571/query`,
  'POST',
  {
    filter: {
      and: [
...
const result = await notionRequest('/pages', 'POST', {
  parent: { database_id: '7b70e2ab-eae8-4f4e-b1b3-4054b4df0a48' },
  properties: {
    '月报标题': {
...
```javascript
const result = await notionRequest(
  `/databases/7b70e2ab-eae8-4f4e-b1b3-4054b4df0a48/query`,
  'POST',
  {
    filter: {
      property: '周期',
